...
const KEYS = { clientes:'cd_clientes', commandes:'cd_commandes', catalogue:'cd_catalogue', apprentis:'cd_apprentis', parametres:'cd_parametres', licence:'cd_licence' };
...
/* ===== Catalogue pré-rempli ===== */
function seedCatalogue(){
  return [
  {
    "id": "r1",
    "nom": "Robe fourreau Estelle",
    "categorie": "Robe",
    "description": "Modèle fourreau idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r2",
    "nom": "Robe portefeuille Fatouma",
    "categorie": "Robe",
    "description": "Coupe portefeuille qui souligne la silhouette, finitions soignées."
  },
  {
    "id": "r3",
    "nom": "Robe sirène Véronique",
    "categorie": "Robe",
    "description": "Robe sirène, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r4",
    "nom": "Robe bustier Salimata",
    "categorie": "Robe",
    "description": "Coupe bustier qui souligne la silhouette, finitions soignées."
  },
  {
    "id": "r5",
    "nom": "Robe trapèze Clarisse",
    "categorie": "Robe",
    "description": "Coupe trapèze qui souligne la silhouette, finitions soignées."
  },
  {
    "id": "r6",
    "nom": "Robe cache-cœur Djamila",
    "categorie": "Robe",
    "description": "Modèle cache-cœur idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r7",
    "nom": "Robe asymétrique Wilhelmine",
    "categorie": "Robe",
    "description": "Modèle asymétrique idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r8",
    "nom": "Robe péplum Zara",
    "categorie": "Robe",
    "description": "Modèle péplum idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r9",
    "nom": "Robe taille empire Yvette",
    "categorie": "Robe",
    "description": "Robe taille empire, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r10",
    "nom": "Robe dos-nu Afiwa",
    "categorie": "Robe",
    "description": "Coupe dos-nu qui souligne la silhouette, finitions soignées."
  },
  {
    "id": "r11",
    "nom": "Robe chemise Rahama",
    "categorie": "Robe",
    "description": "Robe chemise, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r12",
    "nom": "Robe kimono Carine",
    "categorie": "Robe",
    "description": "Robe kimono avec fermeture éclair invisible et ourlet travaillé main."
  },
  {
    "id": "r13",
    "nom": "Robe plissée Reine",
    "categorie": "Robe",
    "description": "Modèle plissée idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r14",
    "nom": "Robe imprimé wax Latifa",
    "categorie": "Robe",
    "description": "Modèle imprimé wax idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r15",
    "nom": "Robe longue fendue Prisca",
    "categorie": "Robe",
    "description": "Robe longue fendue, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r16",
    "nom": "Robe bohème Pauline",
    "categorie": "Robe",
    "description": "Modèle bohème idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r17",
    "nom": "Robe corolle Ola",
    "categorie": "Robe",
    "description": "Modèle corolle idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r18",
    "nom": "Robe structurée Rokia",
    "categorie": "Robe",
    "description": "Robe structurée, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r19",
    "nom": "Robe enveloppe Raïssa",
    "categorie": "Robe",
    "description": "Robe enveloppe, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r20",
    "nom": "Robe croisée Fanta",
    "categorie": "Robe",
    "description": "Robe croisée avec fermeture éclair invisible et ourlet travaillé main."
  },
  {
    "id": "r21",
    "nom": "Robe drapée Grâce",
    "categorie": "Robe",
    "description": "Robe drapée, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r22",
    "nom": "Robe ceinturée Bintou",
    "categorie": "Robe",
    "description": "Robe ceinturée, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r23",
    "nom": "Robe évasée Habiba",
    "categorie": "Robe",
    "description": "Modèle évasée idéal pour les grandes occasions comme le quotidien."
  },
  {
    "id": "r24",
    "nom": "Robe ajustée Mariam",
    "categorie": "Robe",
    "description": "Robe ajustée avec fermeture éclair invisible et ourlet travaillé main."
  },
  {
    "id": "r25",
    "nom": "Robe manches ballon Huguette",
    "categorie": "Robe",
    "description": "Robe manches ballon, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r26",
    "nom": "Robe col claudine Aminata",
    "categorie": "Robe",
    "description": "Robe col claudine avec fermeture éclair invisible et ourlet travaillé main."
  },
  {
    "id": "r27",
    "nom": "Robe encolure carrée Adaeze",
    "categorie": "Robe",
    "description": "Coupe encolure carrée qui souligne la silhouette, finitions soignées."
  },
  {
    "id": "r28",
    "nom": "Robe de cérémonie Kadiatou",
    "categorie": "Robe",
    "description": "Robe de cérémonie, tissu au choix, doublure intérieure confortable."
  },
  {
    "id": "r29",
    "nom": "Robe cocktail Bibiane",
    "categorie": "Robe",
    "description": "Robe cocktail avec fermeture éclair invisible et ourlet travaillé main."
  },
  {
    "id": "r30",
    "nom": "Robe patineuse Thérèse",
    "categorie": "Robe",
    "description": "Robe patineuse avec fermeture éclair invisible et ourlet travaillé main."
  },
  {
    "id": "cj1",
    "nom": "Complet Veste courte cintrée & Jupe crayon Rachidatou",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe crayon, tissu structuré au choix."
  },
  {
    "id": "cj2",
    "nom": "Complet Veste courte cintrée & Jupe évasée Edwige",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe évasée, tissu structuré au choix."
  },
  {
    "id": "cj3",
    "nom": "Complet Veste courte cintrée & Jupe plissée Florence",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe plissée, tissu structuré au choix."
  },
  {
    "id": "cj4",
    "nom": "Complet Veste courte cintrée & Jupe trapèze Colette",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe trapèze, tissu structuré au choix."
  },
  {
    "id": "cj5",
    "nom": "Complet Veste courte cintrée & Jupe droite fendue Odile",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe droite fendue, tissu structuré au choix."
  },
  {
    "id": "cj6",
    "nom": "Complet Veste courte cintrée & Jupe taille haute Efua",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe taille haute, tissu structuré au choix."
  },
  {
    "id": "cj7",
    "nom": "Complet Veste courte cintrée & Jupe asymétrique Béatrice",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe asymétrique, tissu structuré au choix."
  },
  {
    "id": "cj8",
    "nom": "Complet Veste courte cintrée & Jupe portefeuille Irène",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe portefeuille, tissu structuré au choix."
  },
  {
    "id": "cj9",
    "nom": "Complet Veste courte cintrée & Jupe midi Sandrine",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe midi, tissu structuré au choix."
  },
  {
    "id": "cj10",
    "nom": "Complet Veste courte cintrée & Jupe patineuse Ursule",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste courte cintrée assortie à une jupe patineuse, tissu structuré au choix."
  },
  {
    "id": "cj11",
    "nom": "Complet Veste longue droite & Jupe crayon Awa",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe crayon, tissu structuré au choix."
  },
  {
    "id": "cj12",
    "nom": "Complet Veste longue droite & Jupe évasée Mireille",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe évasée, tissu structuré au choix."
  },
  {
    "id": "cj13",
    "nom": "Complet Veste longue droite & Jupe plissée Yolande",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe plissée, tissu structuré au choix."
  },
  {
    "id": "cj14",
    "nom": "Complet Veste longue droite & Jupe trapèze Amara",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe trapèze, tissu structuré au choix."
  },
  {
    "id": "cj15",
    "nom": "Complet Veste longue droite & Jupe droite fendue Solange",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe droite fendue, tissu structuré au choix."
  },
  {
    "id": "cj16",
    "nom": "Complet Veste longue droite & Jupe taille haute Denise",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe taille haute, tissu structuré au choix."
  },
  {
    "id": "cj17",
    "nom": "Complet Veste longue droite & Jupe asymétrique Zainab",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe asymétrique, tissu structuré au choix."
  },
  {
    "id": "cj18",
    "nom": "Complet Veste longue droite & Jupe portefeuille Alice",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe portefeuille, tissu structuré au choix."
  },
  {
    "id": "cj19",
    "nom": "Complet Veste longue droite & Jupe midi Sidonie",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe midi, tissu structuré au choix."
  },
  {
    "id": "cj20",
    "nom": "Complet Veste longue droite & Jupe patineuse Judith",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : veste longue droite assortie à une jupe patineuse, tissu structuré au choix."
  },
  {
    "id": "cj21",
    "nom": "Complet Blazer structuré & Jupe crayon Nala",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe crayon, tissu structuré au choix."
  },
  {
    "id": "cj22",
    "nom": "Complet Blazer structuré & Jupe évasée Xaviera",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe évasée, tissu structuré au choix."
  },
  {
    "id": "cj23",
    "nom": "Complet Blazer structuré & Jupe plissée Aïcha",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe plissée, tissu structuré au choix."
  },
  {
    "id": "cj24",
    "nom": "Complet Blazer structuré & Jupe trapèze Chantal",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe trapèze, tissu structuré au choix."
  },
  {
    "id": "cj25",
    "nom": "Complet Blazer structuré & Jupe droite fendue Joséphine",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe droite fendue, tissu structuré au choix."
  },
  {
    "id": "cj26",
    "nom": "Complet Blazer structuré & Jupe taille haute Sefinat",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe taille haute, tissu structuré au choix."
  },
  {
    "id": "cj27",
    "nom": "Complet Blazer structuré & Jupe asymétrique Nadège",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe asymétrique, tissu structuré au choix."
  },
  {
    "id": "cj28",
    "nom": "Complet Blazer structuré & Jupe portefeuille Yara",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe portefeuille, tissu structuré au choix."
  },
  {
    "id": "cj29",
    "nom": "Complet Blazer structuré & Jupe midi Adjoa",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe midi, tissu structuré au choix."
  },
  {
    "id": "cj30",
    "nom": "Complet Blazer structuré & Jupe patineuse Georgette",
    "categorie": "Complet jupe",
    "description": "Ensemble deux pièces : blazer structuré assortie à une jupe patineuse, tissu structuré au choix."
  },
  {
    "id": "b1",
    "nom": "Boubou Estelle",
    "categorie": "Boubou",
    "description": "Boubou grand modèle brodé, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b2",
    "nom": "Boubou Fatouma",
    "categorie": "Boubou",
    "description": "Boubou léger en voile, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b3",
    "nom": "Boubou Véronique",
    "categorie": "Boubou",
    "description": "Boubou façon kaftan, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b4",
    "nom": "Boubou Salimata",
    "categorie": "Boubou",
    "description": "Boubou à manches larges, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b5",
    "nom": "Boubou Clarisse",
    "categorie": "Boubou",
    "description": "Boubou deux pièces, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b6",
    "nom": "Boubou Djamila",
    "categorie": "Boubou",
    "description": "Boubou de cérémonie doré, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b7",
    "nom": "Boubou Wilhelmine",
    "categorie": "Boubou",
    "description": "Boubou en dentelle, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b8",
    "nom": "Boubou Zara",
    "categorie": "Boubou",
    "description": "Boubou moderne fendu, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b9",
    "nom": "Boubou Yvette",
    "categorie": "Boubou",
    "description": "Boubou ample traditionnel, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b10",
    "nom": "Boubou Afiwa",
    "categorie": "Boubou",
    "description": "Boubou col brodé main, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b11",
    "nom": "Boubou Rahama",
    "categorie": "Boubou",
    "description": "Boubou imprimé wax, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b12",
    "nom": "Boubou Carine",
    "categorie": "Boubou",
    "description": "Boubou à ceinture assortie, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b13",
    "nom": "Boubou Reine",
    "categorie": "Boubou",
    "description": "Boubou court moderne, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b14",
    "nom": "Boubou Latifa",
    "categorie": "Boubou",
    "description": "Boubou long majestueux, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b15",
    "nom": "Boubou Prisca",
    "categorie": "Boubou",
    "description": "Boubou à motifs perlés, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b16",
    "nom": "Boubou Pauline",
    "categorie": "Boubou",
    "description": "Boubou épuré minimaliste, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b17",
    "nom": "Boubou Ola",
    "categorie": "Boubou",
    "description": "Boubou à broderie dorée, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b18",
    "nom": "Boubou Rokia",
    "categorie": "Boubou",
    "description": "Boubou fluide d'été, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b19",
    "nom": "Boubou Raïssa",
    "categorie": "Boubou",
    "description": "Boubou structuré chic, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b20",
    "nom": "Boubou Fanta",
    "categorie": "Boubou",
    "description": "Boubou à manches papillon, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b21",
    "nom": "Boubou Grâce",
    "categorie": "Boubou",
    "description": "Boubou de mariage, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b22",
    "nom": "Boubou Bintou",
    "categorie": "Boubou",
    "description": "Boubou de baptême, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b23",
    "nom": "Boubou Habiba",
    "categorie": "Boubou",
    "description": "Boubou pastel léger, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b24",
    "nom": "Boubou Mariam",
    "categorie": "Boubou",
    "description": "Boubou aux tons vifs, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b25",
    "nom": "Boubou Huguette",
    "categorie": "Boubou",
    "description": "Boubou classique intemporel, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b26",
    "nom": "Boubou Aminata",
    "categorie": "Boubou",
    "description": "Boubou revisité tendance, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b27",
    "nom": "Boubou Adaeze",
    "categorie": "Boubou",
    "description": "Boubou à col rond brodé, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b28",
    "nom": "Boubou Kadiatou",
    "categorie": "Boubou",
    "description": "Boubou ample confort, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b29",
    "nom": "Boubou Bibiane",
    "categorie": "Boubou",
    "description": "Boubou noué à la taille, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "b30",
    "nom": "Boubou Thérèse",
    "categorie": "Boubou",
    "description": "Boubou évasé élégant, coupe ample et confortable, tissu au choix (wax, bazin, voile)."
  },
  {
    "id": "e1",
    "nom": "Ensemble Crop top & Jupe wax taille haute Estelle",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe wax taille haute, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e2",
    "nom": "Ensemble Crop top & Jupe évasée Fatouma",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe évasée, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e3",
    "nom": "Ensemble Crop top & Jupe crayon assortie Véronique",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe crayon assortie, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e4",
    "nom": "Ensemble Crop top & Jupe longue fendue Salimata",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe longue fendue, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e5",
    "nom": "Ensemble Crop top & Jupe portefeuille Clarisse",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe portefeuille, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e6",
    "nom": "Ensemble Crop top & Short chic Djamila",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une short chic, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e7",
    "nom": "Ensemble Crop top & Jupe plissée courte Wilhelmine",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe plissée courte, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e8",
    "nom": "Ensemble Crop top & Jupe midi Zara",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe midi, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e9",
    "nom": "Ensemble Crop top & Jupe drapée Yvette",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe drapée, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e10",
    "nom": "Ensemble Crop top & Jupe patineuse courte Afiwa",
    "categorie": "Ensemble",
    "description": "Crop top assorti à une jupe patineuse courte, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e11",
    "nom": "Ensemble Haut boule & Jupe wax taille haute Rahama",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe wax taille haute, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e12",
    "nom": "Ensemble Haut boule & Jupe évasée Carine",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe évasée, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e13",
    "nom": "Ensemble Haut boule & Jupe crayon assortie Reine",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe crayon assortie, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e14",
    "nom": "Ensemble Haut boule & Jupe longue fendue Latifa",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe longue fendue, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e15",
    "nom": "Ensemble Haut boule & Jupe portefeuille Prisca",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe portefeuille, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e16",
    "nom": "Ensemble Haut boule & Short chic Pauline",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une short chic, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e17",
    "nom": "Ensemble Haut boule & Jupe plissée courte Ola",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe plissée courte, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e18",
    "nom": "Ensemble Haut boule & Jupe midi Rokia",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe midi, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e19",
    "nom": "Ensemble Haut boule & Jupe drapée Raïssa",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe drapée, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e20",
    "nom": "Ensemble Haut boule & Jupe patineuse courte Fanta",
    "categorie": "Ensemble",
    "description": "Haut boule assorti à une jupe patineuse courte, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e21",
    "nom": "Ensemble Chemisier & Jupe wax taille haute Grâce",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe wax taille haute, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e22",
    "nom": "Ensemble Chemisier & Jupe évasée Bintou",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe évasée, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e23",
    "nom": "Ensemble Chemisier & Jupe crayon assortie Habiba",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe crayon assortie, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e24",
    "nom": "Ensemble Chemisier & Jupe longue fendue Mariam",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe longue fendue, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e25",
    "nom": "Ensemble Chemisier & Jupe portefeuille Huguette",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe portefeuille, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e26",
    "nom": "Ensemble Chemisier & Short chic Aminata",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une short chic, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e27",
    "nom": "Ensemble Chemisier & Jupe plissée courte Adaeze",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe plissée courte, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e28",
    "nom": "Ensemble Chemisier & Jupe midi Kadiatou",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe midi, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e29",
    "nom": "Ensemble Chemisier & Jupe drapée Bibiane",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe drapée, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "e30",
    "nom": "Ensemble Chemisier & Jupe patineuse courte Thérèse",
    "categorie": "Ensemble",
    "description": "Chemisier assorti à une jupe patineuse courte, ensemble deux pièces coordonné, tissu wax ou uni."
  },
  {
    "id": "bb1",
    "nom": "Boumba Rachidatou",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, classique, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb2",
    "nom": "Boumba Edwige",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, brodé perles, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb3",
    "nom": "Boumba Florence",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, wax deux pièces, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb4",
    "nom": "Boumba Colette",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, foulard assorti, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb5",
    "nom": "Boumba Odile",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, cérémonie royale, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb6",
    "nom": "Boumba Efua",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, tissu bazin riche, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb7",
    "nom": "Boumba Béatrice",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, broderie dorée, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb8",
    "nom": "Boumba Irène",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, manches amples, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb9",
    "nom": "Boumba Sandrine",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, taille cintrée, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb10",
    "nom": "Boumba Ursule",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, coupe moderne, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb11",
    "nom": "Boumba Awa",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, motifs traditionnels, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb12",
    "nom": "Boumba Mireille",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, couleurs vives, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb13",
    "nom": "Boumba Yolande",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, pagne noué, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb14",
    "nom": "Boumba Amara",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, haut brodé, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb15",
    "nom": "Boumba Solange",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, ensemble complet, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb16",
    "nom": "Boumba Denise",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, style Borgou, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb17",
    "nom": "Boumba Zainab",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, style Bariba, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb18",
    "nom": "Boumba Alice",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, tenue de fête, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb19",
    "nom": "Boumba Sidonie",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, tenue de mariage, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb20",
    "nom": "Boumba Judith",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, version courte, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb21",
    "nom": "Boumba Nala",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, version longue, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb22",
    "nom": "Boumba Xaviera",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, col arrondi, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb23",
    "nom": "Boumba Aïcha",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, à ceinture tissée, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb24",
    "nom": "Boumba Chantal",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, imprimé géométrique, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb25",
    "nom": "Boumba Joséphine",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, tons pastel, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb26",
    "nom": "Boumba Sefinat",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, finition dentelle, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb27",
    "nom": "Boumba Nadège",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, coupe ample, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb28",
    "nom": "Boumba Yara",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, coupe ajustée, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb29",
    "nom": "Boumba Adjoa",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, édition cérémonie, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "bb30",
    "nom": "Boumba Georgette",
    "categorie": "Modèle Boumba Bénin",
    "description": "Tenue traditionnelle béninoise Boumba, modèle revisité, pagne wax ou bazin avec foulard assorti sur demande."
  },
  {
    "id": "pc1",
    "nom": "Complet Chemisier ample & Pantalon large Estelle",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon large, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc2",
    "nom": "Complet Chemisier ample & Pantalon droit Fatouma",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon droit, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc3",
    "nom": "Complet Chemisier ample & Pantalon palazzo Véronique",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon palazzo, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc4",
    "nom": "Complet Chemisier ample & Pantalon fuselé taille haute Salimata",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon fuselé taille haute, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc5",
    "nom": "Complet Chemisier ample & Pantalon carotte Clarisse",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon carotte, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc6",
    "nom": "Complet Chemisier ample & Pantalon évasé Djamila",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon évasé, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc7",
    "nom": "Complet Chemisier ample & Pantalon 7/8 Wilhelmine",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon 7/8, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc8",
    "nom": "Complet Chemisier ample & Pantalon cigarette Zara",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon cigarette, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc9",
    "nom": "Complet Chemisier ample & Pantalon fluide Yvette",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon fluide, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc10",
    "nom": "Complet Chemisier ample & Pantalon tailleur Afiwa",
    "categorie": "Pantalon complet",
    "description": "Chemisier ample assorti à un pantalon tailleur, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc11",
    "nom": "Complet Haut cache-cœur & Pantalon large Rahama",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon large, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc12",
    "nom": "Complet Haut cache-cœur & Pantalon droit Carine",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon droit, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc13",
    "nom": "Complet Haut cache-cœur & Pantalon palazzo Reine",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon palazzo, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc14",
    "nom": "Complet Haut cache-cœur & Pantalon fuselé taille haute Latifa",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon fuselé taille haute, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc15",
    "nom": "Complet Haut cache-cœur & Pantalon carotte Prisca",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon carotte, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc16",
    "nom": "Complet Haut cache-cœur & Pantalon évasé Pauline",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon évasé, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc17",
    "nom": "Complet Haut cache-cœur & Pantalon 7/8 Ola",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon 7/8, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc18",
    "nom": "Complet Haut cache-cœur & Pantalon cigarette Rokia",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon cigarette, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc19",
    "nom": "Complet Haut cache-cœur & Pantalon fluide Raïssa",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon fluide, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc20",
    "nom": "Complet Haut cache-cœur & Pantalon tailleur Fanta",
    "categorie": "Pantalon complet",
    "description": "Haut cache-cœur assorti à un pantalon tailleur, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc21",
    "nom": "Complet Veste courte & Pantalon large Grâce",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon large, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc22",
    "nom": "Complet Veste courte & Pantalon droit Bintou",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon droit, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc23",
    "nom": "Complet Veste courte & Pantalon palazzo Habiba",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon palazzo, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc24",
    "nom": "Complet Veste courte & Pantalon fuselé taille haute Mariam",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon fuselé taille haute, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc25",
    "nom": "Complet Veste courte & Pantalon carotte Huguette",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon carotte, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc26",
    "nom": "Complet Veste courte & Pantalon évasé Aminata",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon évasé, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc27",
    "nom": "Complet Veste courte & Pantalon 7/8 Adaeze",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon 7/8, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc28",
    "nom": "Complet Veste courte & Pantalon cigarette Kadiatou",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon cigarette, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc29",
    "nom": "Complet Veste courte & Pantalon fluide Bibiane",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon fluide, ensemble complet coordonné pour un look moderne."
  },
  {
    "id": "pc30",
    "nom": "Complet Veste courte & Pantalon tailleur Thérèse",
    "categorie": "Pantalon complet",
    "description": "Veste courte assorti à un pantalon tailleur, ensemble complet coordonné pour un look moderne."
  }
];
}
...
/* ===== État ===== */
let state = { view:'dashboard', catFilter:'Toutes', searchQuery:'', editId:null };
...
/* ===== Silhouettes catalogue (motif de signature) ===== */
function silhouette(categorie){
  const paths = {
    'Robe': 'M40 8c-5 0-8 4-8 8 0 3 1 5 3 7l-9 12v45c0 4 3 7 14 7s14-3 14-7V35l-9-12c2-2 3-4 3-7 0-4-3-8-8-8z',
    'Complet jupe': 'M40 8c-5 0-8 4-8 8 0 2 .5 4 2 6L20 30v18h8v39h24V48h8V30l-14-8c1.5-2 2-4 2-6 0-4-3-8-8-8z',
    'Ensemble': 'M40 8c-5 0-8 4-8 8 0 3 1 5 3 7l-9 8v14h28V31l-9-8c2-2 3-4 3-7 0-4-3-8-8-8zM24 52h32l4 35H20z',
    'Boubou': 'M40 6c-6 0-9 4-9 9 0 3 1 5 3 7L14 34l6 8 10-7v52c0 3 4 4 10 4s10-1 10-4V35l10 7 6-8-20-12c2-2 3-4 3-7 0-5-3-9-9-9z',
    'Modèle Boumba Bénin': 'M40 4l-7 7 7 5 7-5-7-7zM40 18c-6 0-9 4-9 9 0 3 1 5 3 7l-11 12 5 7 12-9v46c0 3 4 5 9 5s9-2 9-5V44l12 9 5-7-11-12c2-2 3-4 3-7 0-5-3-9-9-9z',
    'Pantalon complet': 'M28 8h24v20l6 4v14h-9V32h-4v14H29V32h-4v14h-9V32l6-4V8z',
  };
  const d = paths[categorie] || paths['Robe'];
  return `<svg viewBox="0 0 80 100" width="64" height="80"><path d="${d}" fill="none" stroke="#1B3A63" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"/></svg>`;
}
...
function renderDashboard(){
  ...
  root.innerHTML = `
    ...
    <div class="quick-head">
      <h2 class="section-title" style="margin:0;">Accès rapide</h2>
    </div>
    <div class="quick-grid">
      <div class="quick-card c-blue" data-goto="clientes">
        <div class="quick-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10zm0 2c-4.4 0-8 2.2-8 5v2h16v-2c0-2.8-3.6-5-8-5z"/></svg></div>
        <p class="quick-title">Clientes</p>
        <p class="quick-desc">Fiches &amp; historique</p>
        <span class="quick-arrow">›</span>
      </div>
      <div class="quick-card c-green" data-goto="commandes">
        <div class="quick-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16v2H4V4zm2 4h12l-1 12H7L6 8zm3 2v8h1v-8H9zm3 0v8h1v-8h-1zm3 0v8h1v-8h-1z"/></svg></div>
        <p class="quick-title">Commandes</p>
        <p class="quick-desc">Suivi &amp; statuts</p>
        <span class="quick-arrow">›</span>
      </div>
      <div class="quick-card c-pink" data-goto="catalogue">
        <div class="quick-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h7v7H4V4zm9 0h7v7h-7V4zM4 13h7v7H4v-7zm9 0h7v7h-7v-7z"/></svg></div>
        <p class="quick-title">Catalogue</p>
        <p class="quick-desc">Modèles &amp; prix</p>
        <span class="quick-arrow">›</span>
      </div>
      <div class="quick-card c-orange" data-goto="apprentis">
        <div class="quick-icon"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3zM5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82z"/></svg></div>
        <p class="quick-title">Apprentis</p>
        <p class="quick-desc">Contrats &amp; suivi</p>
        <span class="quick-arrow">›</span>
      </div>
    </div>
    ...
    <div class="dash-block">
      ...
      }).join('') : '<p class="empty-note">Aucune livraison programmée pour le moment.</p>'}
    </div>
  ...
  root.innerHTML = `
    ...
    <div class="dash-block">
      ...
      ${commandes.length ? commandes.slice().reverse().map(c=>`
        <div class="list-row" data-open-commande="${c.id}">
          <div class="row-main">
          ...
          <div class="row-side"><span class="status-chip status-${c.statut}">${statutLabel(c.statut)}</span></div>
    ...
    <div class="dash-block" style="padding-top:4px;">
      ${commandes.length ? commandes.slice().reverse().map(c=>{
        ...
        return `<div class="list-row" data-open-commande="${c.id}">
          ...
          <div class="row-side"><span class="status-chip ${late?'status-retard':'status-'+c.statut}">${late?'Retard':statutLabel(c.statut)}</span></div>
        </div>`;
  ...
  showModal(`
    ...
    <form id="form-commande">
      ...
      <div class="form-group">
        <label>Statut</label>
        <select name="statut">
          ${STATUTS.map(s=>`<option value="${s.k}" ${(existing?existing.statut:'nouvelle')===s.k?'selected':''}>${s.l}</option>`).join('')}
        </select>
      </div>
      <div class="form-group"><label>Notes</label><textarea name="notes" rows="2">${escapeHtml(existing?.notes||'')}</textarea></div>
      <div class="modal-actions">
...
function openCommandeDetail(id){
  ...
  root.innerHTML = `
    ...
    <div class="dash-block">
      ...
      <p style="margin:6px 0;">Statut : <span class="status-chip status-${c.statut}">${statutLabel(c.statut)}</span></p>
      <p style="margin:6px 0;">Commandé le ${fmtDate(c.dateCommande)} · Livraison prévue le ${fmtDate(c.dateLivraisonPrevue)}</p>
...
function catalogueFiltre(){
  const catalogue = DB.get(KEYS.catalogue, []);
  let filtered = state.catFilter==='Toutes' ? catalogue : catalogue.filter(m=>m.categorie===state.catFilter);
...
function renderCatalogue(){
  const catalogue = DB.get(KEYS.catalogue, []);
  const categories = ['Toutes', ...Array.from(new Set(catalogue.map(m=>m.categorie)))];
  const filtered = catalogueFiltre();

  root.innerHTML = `
    <h2 class="section-title" style="margin-bottom:10px;">Catalogue de modèles</h2>
    <div class="cat-add-row">
      <button class="btn btn-primary" id="btn-add-modele">+ Modèle</button>
      <button class="btn btn-outline" id="btn-bulk-photos">+ Plusieurs photos</button>
    </div>
    <div class="search-bar">
      <svg width="16" height="16" viewBox="0 0 24 24"><path d="M10 3a7 7 0 1 0 4.32 12.53l5.08 5.08 1.41-1.41-5.08-5.08A7 7 0 0 0 10 3zm0 2a5 5 0 1 1 0 10 5 5 0 0 1 0-10z" fill="#a89a89"/></svg>
      <input type="text" id="cat-search-input" placeholder="Rechercher un modèle..." value="${escapeAttr(state.catSearch||'')}">
    </div>
    <div class="cat-filters">
      ${categories.map(c=>`<button class="chip-filter ${state.catFilter===c?'active':''}" data-cat="${escapeAttr(c)}">${escapeHtml(c)}</button>`).join('')}
    </div>
    ...
    <div class="cat-grid">
      ${filtered.length ? filtered.map(m=>`
        <div class="cat-card" data-open-modele="${m.id}">
          <div class="cat-illus" data-illus="${m.id}">${silhouette(m.categorie)}${m.hasVideo?'<span class="video-badge">▶</span>':''}</div>
          <div class="cat-body">
            <div class="cat-name">${escapeHtml(m.nom)}</div>
            <div class="cat-cat">${escapeHtml(m.categorie)}</div>
          </div>
        </div>
      `).join('') : '<p class="empty-note" style="grid-column:1/-1;">Aucun modèle ne correspond à cette recherche.</p>'}
    </div>
  `;
  document.getElementById('btn-add-modele').addEventListener('click', ()=>openModeleForm());
  document.getElementById('btn-bulk-photos').addEventListener('click', ()=>openBulkPhotoForm());
  root.querySelectorAll('[data-cat]').forEach(el=>el.addEventListener('click', ()=>{ state.catFilter = el.dataset.cat; renderCatalogue(); }));
...
function openModeleForm(id){
  const catalogue = DB.get(KEYS.catalogue, []);
  const existing = id ? catalogue.find(m=>m.id===id) : null;
  const categoriesExistantes = Array.from(new Set(catalogue.map(m=>m.categorie)));
  let pendingPhoto = null; // null = inchangé (on garde l'existante) ; false = supprimée ; dataURL = nouvelle
  ...
  let pendingVideoPoster = null; // vignette générée depuis la vidéo, utilisée si aucune photo n'est fournie

  showModal(`
    <div class="modal-handle"></div>
    <div class="modal-title">${existing?'Modifier le modèle':'Nouveau modèle'}</div>
    <form id="form-modele">
      <div class="form-group">
        <label>Photo</label>
        <div id="photo-preview-wrap" class="photo-preview-wrap">
          ${existing?.hasPhoto ? `<div class="photo-preview-empty">Chargement de la photo…</div>` : `<div id="photo-preview-empty" class="photo-preview-empty">Aucune photo — l'illustration par défaut sera utilisée</div>`}
        </div>
      ...
      <div class="form-group">
        ...
        <p style="margin:6px 0 0;color:#a89a89;font-size:0.76rem;">Les vidéos courtes et légères (idéalement moins de 20 Mo) s'enregistrent plus vite et prennent moins de place.</p>
      </div>
      <div class="form-group"><label>Nom du modèle</label><input type="text" name="nom" required value="${escapeAttr(existing?.nom||'')}"></div>
      <div class="form-group">
        <label>Catégorie</label>
        <input type="text" name="categorie" required list="cat-list" value="${escapeAttr(existing?.categorie||'')}" placeholder="ex: Robe, Boubou...">
        <datalist id="cat-list">${categoriesExistantes.map(c=>`<option value="${escapeAttr(c)}">`).join('')}</datalist>
      </div>
      <div class="form-group"><label>Description</label><textarea name="description" rows="3" required>${escapeHtml(existing?.description||'')}</textarea></div>
      <div class="modal-actions">
        <button type="button" class="btn btn-ghost" id="btn-cancel">Annuler</button>
  ...
  // Si on modifie un modèle existant qui a déjà une photo, on la charge
  // depuis IndexedDB pour l'aperçu (elle n'est plus dans localStorage).
  if(existing?.hasPhoto){
    PhotoStore.get(existing.id).then(photo=>{
      const wrap = document.getElementById('photo-preview-wrap');
      if(!wrap) return; // la modale a été fermée entre-temps
      wrap.innerHTML = photo ? `<img id="photo-preview" src="${photo}">` : `<div class="photo-preview-empty">Aucune photo — l'illustration par défaut sera utilisée</div>`;
    });
  }
  ...
  document.getElementById('form-modele').addEventListener('submit', async (e)=>{
    e.preventDefault();
    const fd = new FormData(e.target);
    const id2 = existing ? existing.id : uid();
    ...
    // Photo et vidéo (potentiellement lourdes) sont stockées à part, dans
    // IndexedDB, pour ne jamais saturer le localStorage même avec des
    // centaines de modèles.
    if(pendingPhotoChanged){
      if(pendingPhoto) await PhotoStore.set(id2, pendingPhoto);
      else await PhotoStore.delete(id2);
    }
    if(pendingVideoChanged){
      if(pendingVideo) await VideoStore.set(id2, pendingVideo);
      else await VideoStore.delete(id2);
    }
    const list = DB.get(KEYS.catalogue, []);
    if(existing){ const i=list.findIndex(m=>m.id===existing.id); list[i]=data; }
    else list.push(data);
...
function openBulkPhotoForm(){
  const catalogue = DB.get(KEYS.catalogue, []);
  const categoriesExistantes = Array.from(new Set(catalogue.map(m=>m.categorie)));
  let items = []; // {photo, nom, categorie}
    ...
    listEl.innerHTML = items.map((it, i) => `
      <div class="bulk-row">
        ...
        <div class="bulk-fields">
          <input type="text" placeholder="Nom du modèle" value="${escapeAttr(it.nom)}" data-i="${i}" data-field="nom">
          <input type="text" placeholder="Catégorie" value="${escapeAttr(it.categorie)}" data-i="${i}" data-field="categorie" list="cat-list-bulk">
        </div>
  ...
  showModal(`
    <div class="modal-handle"></div>
    <div class="modal-title">Ajouter plusieurs photos</div>
    <p style="margin:-8px 0 14px;color:#8a7f71;font-size:0.85rem;">Sélectionnez plusieurs photos, puis donnez un nom et une catégorie à chacune.</p>
    <div class="form-group">
      <label>Choisir des photos</label>
      <input type="file" accept="image/*" multiple id="input-bulk-photos">
    </div>
    <datalist id="cat-list-bulk">${categoriesExistantes.map(c=>`<option value="${escapeAttr(c)}">`).join('')}</datalist>
    <div id="bulk-list"></div>
    <div class="modal-actions" id="bulk-actions" style="display:none;">
      <button type="button" class="btn btn-ghost" id="btn-cancel-bulk">Annuler</button>
      <button type="button" class="btn btn-primary" id="btn-save-bulk">Enregistrer tout</button>
    </div>
  `);

  document.getElementById('btn-cancel-bulk').addEventListener('click', closeModal);
  document.getElementById('btn-save-bulk').addEventListener('click', async ()=>{
    const invalid = items.some(it => !it.nom.trim() || !it.categorie.trim());
    if(invalid){ alert('Merci de renseigner un nom et une catégorie pour chaque photo.'); return; }
    ...
    const list = DB.get(KEYS.catalogue, []);
    const nouveaux = items.map(it => ({ id: uid(), nom: it.nom.trim(), categorie: it.categorie.trim(), description: '', photo: it.photo }));

    // Les photos vont dans IndexedDB (bien plus vaste que le localStorage),
    // ce qui permet d'ajouter des centaines de modèles illustrés sans risquer
    // de saturer la mémoire du téléphone.
    let manquantes = 0;
    for(const n of nouveaux){
      const ok = await PhotoStore.set(n.id, n.photo);
      if(!ok) manquantes++;
    }
    const metaSeule = nouveaux.map(({photo, ...rest}) => ({ ...rest, hasPhoto: true }));

    const ok = DB.set(KEYS.catalogue, [...list, ...metaSeule]);
    if(!ok){
      alert("Échec de l'enregistrement : la mémoire de stockage du téléphone semble pleine. Essayez d'ajouter moins de photos à la fois, ou libérez de l'espace.");
      saveBtn.disabled = false;
    ...
    if(manquantes>0){
      alert(`${nouveaux.length} modèle(s) enregistré(s), mais ${manquantes} photo(s) n'ont pas pu être sauvegardées : mémoire de stockage insuffisante. Réessayez de les ajouter une par une depuis chaque modèle.`);
    }
  });
  document.getElementById('input-bulk-photos').addEventListener('change', async (e)=>{
    const files = Array.from(e.target.files || []);
    for(const file of files){
      try{
        // 480px / qualité 0.6 : suffisant pour une vignette de catalogue, et beaucoup
        // plus léger que 640px/0.75 quand on importe plusieurs photos d'un coup.
        const photo = await resizeImageFile(file, 480, 0.6);
        const nomDevine = file.name.replace(/\.[^.]+$/, '').replace(/[_-]+/g, ' ').trim();
        items.push({ photo, nom: nomDevine || 'Nouveau modèle', categorie: categoriesExistantes[0] || '' });
...
function openModeleDetail(id){
  ...
  root.innerHTML = `
    ...
    <div class="detail-nav">
      ...
      <div class="detail-illus" id="detail-illus-wrap">${silhouette(m.categorie).replace('width="64" height="80"','width="140" height="175"')}</div>
    ...
    <div class="top-actions">
      <h2 class="section-title" style="margin:0;" id="detail-titre">${escapeHtml(m.nom)}</h2>
      <button class="btn btn-outline" id="btn-edit-modele">Modifier</button>
    </div>
    <p style="color:var(--or);font-weight:600;text-transform:uppercase;font-size:.78rem;letter-spacing:.04em;margin-top:-10px;" id="detail-categorie">${escapeHtml(m.categorie)}</p>
    <div class="dash-block" id="detail-description-wrap">
      <p style="margin:2px 0;${m.description?'':'color:#a89a89;font-style:italic;'}" id="detail-description">${m.description ? escapeHtml(m.description) : 'Aucune description — modifiez le modèle pour en ajouter une.'}</p>
    </div>
  ...
  if(m.hasPhoto){
    PhotoStore.get(m.id).then(photo=>{
      ...
      wrap.innerHTML = `<img src="${photo}" alt="${escapeAttr(m.nom)}">`;
    });
  }
  if(m.hasVideo){
  ...
  document.getElementById('btn-edit-modele').addEventListener('click', ()=>openModeleForm(id));
  ...
  document.getElementById('btn-order-modele').addEventListener('click', ()=>{
    ...
    setTimeout(()=>{
      ...
      if(modeleInput) modeleInput.value = m.nom;
    }, 0);
  });
...
function openApprentiDetail(id){
  ...
  root.innerHTML = `
    ...
    <div class="dash-block">
      ...
      <button class="btn btn-outline btn-block" id="btn-print-attestation" style="margin-top:8px;">${a.motif==='stagiaire'?'Imprimer l\'attestation de stage':'Imprimer le diplôme de fin d\'apprentissage'}</button>
    </div>
  ...
  document.getElementById('btn-print-attestation').addEventListener('click', ()=>{ a.motif==='stagiaire' ? printAttestation(a) : printDiplome(a); });
...
function watermarkDiv(p){
  if(!p.logo) return '';
  return `<div class="doc-watermark" style="background-image:url('${p.logo}')"></div>`;
}

function docBrandHeader(p){
  return `
...
function certHeader(p, extraClass, innerDividers){
  ...
  return `
    <div class="doc-cert-topbar${extraClass?' '+extraClass:''}">
      ...
      <div class="doc-cert-photobox"></div>
    </div>
  `;
}
        ...
        <div class="doc-cert-inner">
          ...
          <div class="doc-cert-bottom">
            <div class="doc-cert-regbox">
              ...
              <div>N° d'enregistrement : ${vv('....................')}</div>
              <div>Date d'enregistrement : ${vv('....................')}</div>
              <div>Page : ${vv('....................')}</div>
            </div>
            ${certSeal('#C9A227')}
  ...
  const html = `
    <div class="doc-page doc-cert doc-page-diplome doc-navy">
      ...
      <div class="doc-cert-frame-diplome">
        <div class="doc-cert-inner">
          ${certHeader(p, 'doc-cert-topbar-diplome')}
          ${certGoldDivider('#C9A227')}
          <div class="doc-cert-title-wrap">
